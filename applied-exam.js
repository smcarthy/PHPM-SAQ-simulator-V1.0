(function () {
  const TOPIC_META = {
    all: {
      ...
      icon: 'assets/applied/icons/all-phpm-topics-and-hot-topics.png',
      fallbackIcon: 'assets/applied/icons/all-phpm-topics-and-hot-topics.svg',
      color: '#2e5da8'
    },
    'health-promotion': {
      id: 'health-promotion',
      label: 'Health Promotion, Chronic Diseases, Mental Health and Substance Use',
      icon: 'assets/applied/icons/health-promotion-chronic-diseases-mental-health-and-substance-use.png',
      fallbackIcon: 'assets/applied/icons/health-promotion-chronic-diseases-mental-health-and-substance-use.svg',
      color: '#8d2f87'
    },
    'communicable': {
      id: 'communicable',
      label: 'Communicable Diseases in Health Protection',
      icon: 'assets/applied/icons/communicable-diseases-in-health-protection.png',
      fallbackIcon: 'assets/applied/icons/communicable-diseases-in-health-protection.svg',
      color: '#b7472a'
    },
    'environment': {
      id: 'environment',
      label: 'Environmental, Occupational, Built Environment and Injuries',
      icon: 'assets/applied/icons/environmental-occupational-built-environment-and-injuries.png',
      fallbackIcon: 'assets/applied/icons/environmental-occupational-built-environment-and-injuries.svg',
      color: '#2e7d4f'
    },
    'systems': {
      id: 'systems',
      label: 'Health Systems, Policy, Law and Ethics',
      icon: 'assets/applied/icons/health-systems-policy-law-and-ethics.png',
      fallbackIcon: 'assets/applied/icons/health-systems-policy-law-and-ethics.svg',
      color: '#196f84'
    },
    'methods': {
      id: 'methods',
      label: 'Population Health, Epidemiology, Methods and Basic Sciences',
      icon: 'assets/applied/icons/population-health-epidemiology-methods-and-basic-sciences.png',
      fallbackIcon: 'assets/applied/icons/population-health-epidemiology-methods-and-basic-sciences.svg',
      color: '#4b4ea1'
    },
    'management': {
      id: 'management',
      label: 'Management, Leadership and Program Planning',
      icon: 'assets/applied/icons/management-leadership-and-program-planning.png',
      fallbackIcon: 'assets/applied/icons/management-leadership-and-program-planning.svg',
      color: '#bf7a13'
    },
    'emergency': {
      id: 'emergency',
      label: 'Emergency Preparedness and Response',
      icon: 'assets/applied/icons/emergency-preparedness-and-response.png',
      fallbackIcon: 'assets/applied/icons/emergency-preparedness-and-response.svg',
      color: '#a02929'
    },
    'maternal': {
      id: 'maternal',
      label: 'Maternal and Child Health',
      icon: 'assets/applied/icons/maternal-and-child-health.png',
      fallbackIcon: 'assets/applied/icons/maternal-and-child-health.svg',
      color: '#c24e7b'
    }
  };
  ...
  function bindLauncherIconFallbacks() {
    const icons = document.querySelectorAll('.gpt-launcher-icon[data-fallback-icon]');
    icons.forEach((icon) => {
      icon.addEventListener('error', () => {
        ...
        const fallbackIcon = icon.dataset.fallbackIcon;
        if (!fallbackIcon || icon.dataset.fallbackApplied === 'true') {
          return;
        }
      ...
      return `
        <article class="gpt-launcher-item" style="--topic-color:${topic.color}">
          <a class="gpt-launcher-card" href="${launcher.url}" target="_blank" rel="noopener noreferrer" aria-label="Open ${escapeHtml(launcher.title)}">
            <img src="${topic.icon}" data-fallback-icon="${topic.fallbackIcon || ''}" alt="${escapeHtml(launcher.title)} icon" class="gpt-launcher-icon" loading="lazy" />
